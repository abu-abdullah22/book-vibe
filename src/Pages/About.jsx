      ...
      <div className="container flex flex-col justify-center p-6 mx-auto sm:py-12 lg:py-24 lg:flex-row lg:justify-around">
        ...
        <div className="flex flex-col justify-center text-lg text-center rounded-sm lg:max-w-md xl:max-w-lg lg:text-left">
          ...
          <p className="mt-6 mb-8 sm:mb-12 text-[#131313B2]">
            ...
            Whether you're a seasoned bibliophile or a casual reader looking for
            ...
            classics to contemporary bestsellers, ensuring there's something for
            ...
            titles—it's a vibrant community of book lovers, united by our shared
